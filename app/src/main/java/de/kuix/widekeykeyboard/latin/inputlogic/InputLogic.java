...
package de.kuix.widekeykeyboard.latin.inputlogic;
...
import de.kuix.widekeykeyboard.latin.RichInputConnection;
...
import de.kuix.widekeykeyboard.latin.utils.InputTypeUtils;
import de.kuix.widekeykeyboard.latin.utils.RecapitalizeStatus;
import de.kuix.widekeykeyboard.latin.utils.SubtypeLocaleUtils;
...
public final class InputLogic {
    ...
    private boolean layoutUsesAutoCaps(final String layoutSetName) {
        switch (layoutSetName) {
            ...
            case SubtypeLocaleUtils.LAYOUT_DOUBLETAP_FARSI:
